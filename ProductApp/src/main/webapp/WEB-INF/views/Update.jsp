...
<div class="container">
    <div class="form-card">
        <h2 class="text-center text-primary mb-4">
            <i class="fa-solid fa-file-pen"></i>Update Product Details
        </h2>
        ...
        <input type="hidden" name="productId" value="${product.productId}" />
            ...
            <div class="form-group mb-3">
                ...
                <textarea class="form-control" id="productDescription" 
                          ...
                          placeholder="Enter product description" required>${product.productDescription }</textarea>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <input type="number" step="0.01" class="form-control" id="productPrice"
                       name="productPrice" placeholder="Enter product price" value="${product.productPrice }" required>
            </div>
